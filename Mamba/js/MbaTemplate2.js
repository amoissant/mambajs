function MbaTemplate2(template, directivesPrecursor){
    ...
    MbaTemplate2.prototype.init = function(template, directivesPrecursor){
    ...
    MbaTemplate2.prototype.getRootDirective = function(){
        return this._rootDirective;    
    };
    
    MbaTemplate2.prototype.getTemplate = function(){
        return this._template;
    };
    
    MbaTemplate2.prototype.getTemplateDirective = function(){
        return this._templateDirective;    
    };
    
    MbaTemplate2.prototype.getRootNode = function(){
        return this._rootNode;    
    };
    
    MbaTemplate2.prototype.findDom = function(selector){
        checkType(selector, 'string');
        return this._template.find2(selector);
    }
    
    MbaTemplate2.prototype.findInRenderedDom = function(selector){
        checkType(selector, 'string');
        return this._rootNode.getRenderedDom().find2(selector);
    }
    
    MbaTemplate2.prototype.removeWhiteSpacesFromHtml = function(){
		this._html = this._html.replace(/>\s*</g, "><");
	};
    
    MbaTemplate2.prototype.addTextNodeForBindingText =function(){
        var visitor = new AddTextNodesVisitor(this._template);
        this._rootDirective.visit(visitor);
    };
        
    MbaTemplate2.prototype.constructTemplateDirective = function(){
    ...
    MbaTemplate2.prototype.updateDomForModel = function(model){
    ...
    MbaTemplate2.prototype.prepareForRender = function(){
    ...
    MbaTemplate2.prototype.render = function(model){
    ...
    MbaTemplate2.prototype.updateSuperModelReference = function(model){
