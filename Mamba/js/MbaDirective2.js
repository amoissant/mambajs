function MbaDirective2(precursor, parentPropertyName){
    ...
    MbaDirective2.prototype.init = function(precursor, parentPropertyName){
    ...
    MbaDirective2.prototype.getBindings = function(){
        return this._bindings;
    };
    
    MbaDirective2.prototype.getActionBindings = function(){
        return this._actionBindings;
    };
    
    MbaDirective2.prototype.getSubDirectives = function(){
        return this._subDirectives;
    };
    
    MbaDirective2.prototype.hasRoot = function(){
        return this._rootSelector != null;
    };
    
    MbaDirective2.prototype.getRootSelector = function(){
        return this._rootSelector;
    };
    
    MbaDirective2.prototype.getAccessorChain = function(){
        return this._accessorChain;
    };
    
    MbaDirective2.prototype.initDirectiveAccessorChain = function(parentPropertyName){
        this._accessorChain = this.createAccessorChain(parentPropertyName); 
    };
    
    MbaDirective2.prototype.parsePrecursor = function(){
    ...
    MbaDirective2.prototype.createSubDirective = function(precursor, parentPropertyName){
        checkType(precursor, 'object');
        checkType(parentPropertyName, 'string');
        
        var subDirective = new MbaDirective2(precursor, parentPropertyName);
    ...
    MbaDirective2.prototype.prependAccessors = function(accessorChain){
    ...
    MbaDirective2.prototype.createDirectivesForArray = function(precursorArray, parentPropertyName){
    ...
    MbaDirective2.prototype.isSubDirective = function(propValue){
        return propValue instanceof Object && !(propValue instanceof Array);
    };
    
    MbaDirective2.prototype.isArrayOfSubDirectives = function(propValue){
        return propValue instanceof Array;
    };
    
    MbaDirective2.prototype.isActionBinding = function(prop){
        checkType(prop, 'string');
        return prop.indexOf('/') == 0;
    };
    
    MbaDirective2.prototype.createBindings = function(prop){
        checkType(prop, 'string');
    ...
    MbaDirective2.prototype.createBinding = function(prop, directive){
        checkType(prop, 'string');
        ...
        return new MbaBinding2(selector, anchorProvider, transformation);
    };
    
    MbaDirective2.prototype.createAccessorChain = function(prop){
    ...
    MbaDirective2.prototype.createAccessor = function(prop){
        //TODO : à enrichir pour tous les type d'accesseurs...
        return new MbaFieldAccessor2(prop);
    };
       
    MbaDirective2.prototype.createActionBinding = function(prop){
        checkType(prop, 'string');
    ...
    MbaDirective2.prototype.visit = function(visitor){
